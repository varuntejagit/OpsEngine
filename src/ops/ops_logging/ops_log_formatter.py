...
class OpsLogFormatter(logging.Formatter):
    """
        The OpsLogFormatter class is a custom formatter designed to enhance Python's standard ops_logging.
        Formatter for specific ops_logging requirements. Its primary function is to extract and process additional arguments
